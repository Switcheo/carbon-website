  ...
  return (
    ...
    >
      {items.map((item, index) => {
        ...
        return view === index ? (
          <Box className={clsx(classes.cardContainer, "expandCard", { open: inView })} style={{ backgroundImage: `url("${item?.backgroundImage}")`, boxShadow: "inset 0 0 0 1000px rgba(18,18,18,.5)", backgroundPosition: "-24px -48px" }} key={`${name}-featured-dApps`}>
