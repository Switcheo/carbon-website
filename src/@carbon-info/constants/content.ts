    ...
    tabs: [
      {
        ...
        longDescription: "Stargate is a set of upgrades by Cosmos that will bring significant performance improvements to protocols in the Tendermint ecosystem. Stargate will enable Carbon to support the Inter-blockchain Communication protocol (IBC) that powers cross-chain transactions, and accelerate blockchain performance and UI development via Protobuf, improving overall composability and interoperability for Carbon.",
        status: "In progress",
        progress: 75,
      ...
      },
      {
        ...
        longDescription: "Carbon’s AMM module will see incentive improvements that allow liquidity providers to earn boosted rewards on their liquidity by locking up Switcheo tokens (SWTH) instead of LP tokens. Implemented during Switcheo’s v1.9.0 node software upgrade, boosted rewards are additional rewards earned by liquidity providers for committing (i.e. locking up) their LP tokens. The longer the commitment duration, the greater the boost.",
        status: "In progress",
        progress: 85,
        link: "",
      },
      {
        ...
        longDescription: "The on-chain referral mechanism will enable user interfaces (UIs) built on Carbon to attach a referral address which can attract a percentage commission from trading fees. This commission can be earned when the address has been successfully used to generate a new lead for the platform.",
        status: "In progress",
        progress: 70,
        link: "",
      },
  ...
  },
  {
    ...
    tabs: [
      ...
      },
      {
        ...
        longDescription: "Multi-collateral positions are an upcoming feature on the Carbon protocol that will enable users to trade derivatives using any underlying asset as margin, beyond just USDC. This means that any other token may be used as collateral to open futures positions, increasing flexibility and capital efficiency for traders.",
      ...
      },
      {
        ...
        longDescription: "An innovation within the DeFi realm, Carbon is one of the first protocols to enable AMM support for futures markets. This enables the trading of futures contracts without the need for a counterparty. The AMMs will utilize the constant value quoting strategy and leveraged vaults can be used to increase the AMM’s efficiency.",
      ...
      },
      {
        ...
        longDescription: "Soon to be supported on Carbon, perpetual markets are one of the most common derivatives instruments that are native to the crypto landscape. Similar to traditional futures contracts, what sets perpetuals apart is the absence of a settlement or expiry date.",
      ...
      },
      {
        ...
        longDescription: "Transferable bonded tokens (bSWTH).",
      ...
      },
      {
        ...
        longDescription: "Options markets are financial instruments that allow traders to hedge risks, exploit opportunities, and improve financial and operational efficiency. Largely helmed by centralized exchanges, Carbon will be one of the first protocols to bring decentralized options to the masses.",
      ...
      },
      {
        ...
        longDescription: "Carbon’s insurance fund provides additional protection to assets and prevents the need for auto-deleveraging (ADL) — a form of socialized loss that utilizes trader profits to cover losses caused by other liquidated positions. Powered by Carbon’s layer 2 sidechain, the insurance fund can be bootstrapped from liquidated positions and incentivized contributions from SWTH holders, a mechanism too complex to be adopted by general layer 1 chains.",
    ...
    tabs: [
      {
        ...
        longDescription: "Gravity Bridge is a decentralized bridge that connects Ethereum to Cosmos Hub and vice-versa. It enables the two-way transfer between ERC-20 and Cosmos assets, opening the gateway for further cross-chain transactions. By supporting Gravity Bridge on Carbon, platforms and applications integrated with our protocol will be able to enjoy the benefits of interacting with both Cosmos and Ethereum ecosystems in a direct and decentralized manner.",
        status: "In progress",
        progress: 85,
      ...
      },
      {
        ...
        longDescription: "As its name suggests, Cosmos’ Inter-blockchain Communication (IBC) protocol enables protocols, applications and wallets that utilize Cosmos-SDK to interoperate and communicate with each other seamlessly. By supporting IBC, Carbon will soon be able to interact with ecosystem partners such as ThorChain, Terra and Mirror protocol, opening up a world of possibilities for cross-chain transactions, exchange of data and overall value creation for participating protocols.",
        status: "In progress",
        progress: 85,
      ...
      },
      {
        ...
        longDescription: "The Ethereum Virtual Machine (EVM) is a blockchain-based software that allows for anyone to deploy smart contracts and modules in a sandbox environment on the Ethereum blockchain. With EVM (Web3) support on Carbon, we are able to streamline transactions and approvals directly with Web3 without users having to switch between Metamask and other login methods to approve transactions.",
        status: "In progress",
        progress: 85,
        link: "",
      },
      {
        ...
        longDescription: "Zilliqa is a public blockchain platform with a booming ecosystem of applications and services. Carbon’s integration with Zilliqa will create the ability for Zilliqa assets to transact seamlessly across supported chains on Carbon — including Ethereum, Binance Smart Chain and Neo, and vice-versa. As a derivatives-based trading protocol, Carbon will play a key role in introducing Zilliqa-based derivative products to the ecosystem for the very first time.",
        status: "In progress",
        progress: 70,
        link: "",
      },
      {
        ...
        longDescription: "In addition to native liquidity pools, Carbon will tap on third-party platforms such as Uniswap, Kyber Network and THORChain as liquidity backstops to guarantee deep liquidity that facilitates instantaneous trades, low slippage and tight spreads.",
        status: "In progress",
        progress: 85,
        link: "",
      },
      {
        ...
        longDescription: "As the native token of Carbon, SWTH transacts largely within the protocol. In our vision for truly open finance and accessible markets, creating an ERC-20 and ICS-20 SWTH token standard will enable SWTH to rejoin the broader ecosystem, become a more productive token and significantly broaden the scope of its utility across other DeFi protocols and applications.",
        status: "In progress",
        progress: 50,
    ...
    tabs: [
      {
        ...
        longDescription: "Open-sourcing the Carbon codebase is central in our mission to achieving true decentralization and subverting authority from any single entity. Anyone will be able to access our codes to develop new applications, wallets, and nodes or integrate existing protocols with Carbon. Coupled with the Switcheo Development Fund, we wish to accelerate the growth of Carbon by encouraging community development in order to create a censorship-resistant, robust and highly secure protocol.",
        status: "In progress",
        progress: 85,
        link: "",
      },
      {
        ...
        longDescription: "A key component of any DeFi protocol is the ability to list tokens and markets permissionlessly. Anyone can add liquidity to Carbon's liquidity protocol comprising of an AMM feature for every market. Through Carbon's governance module, anyone will be able to list their desired token or markets instantly, regardless of token popularity or market capital, making Carbon the the go-to Tendermint chain for trading of all kinds of assets.",
        status: "In progress",
        progress: 85,
        link: "",
      },
      {
        ...
        longDescription: "Having API nodes and user interfaces (UIs) hosted by the wider community is vital in decentralizing the protocol. These distributed development points interact independently with Carbon, safeguarding network stability and security as the protocol will not have to rely on any central entity in order to operate. An incentive mechanism will be implemented to attract developers globally to host their own nodes and launch interfaces on Carbon's cutting-edge blockchain.",
        status: "In progress",
        progress: 85,
        link: "",
      },
      {
        ...
        longDescription: "Relayer networks are systems deployed on top of blockchains like Carbon that facilitate order-matching while ensuring transactions are verified and validated by the network.",
        status: "In progress",
        progress: 85,
        link: "",
      },
      {
        ...
        longDescription: "Carbon’s oracles are currently being run by the protocol’s 20 validators who feed external data such as price feeds to the Carbon sidechain. By enabling oracle incentives, Carbon protocol will attract a distributed network of oracle providers that leverage different data sources. Having decentralized oracles are vital to trustlessness, transparency and security of the protocol by ensuring external data being utilized is not centralized and controlled by any single point of authority.",
        status: "In progress",
        progress: 85,
        link: "",
      },
